...
public class StateMachineParallelTest {
    ...
    void testForwardHappyPath() {
        ...
        List<PassEventDto> passEvents2 = createPassEvents(wfInstanceId, LEAVE_APPLICATION, reviewer6, 3, "forwarded",
                E_FORWARD);
     ...
     //   assertEquals(new Pair<>(1, reviewer1), extState.get(KEY_FORWARDED_BY_LAST, Pair.class));
        ...
        List<PassEventDto> passEvents4 = createPassEvents(wfInstanceId, LEAVE_APPLICATION, reviewer1, 1, "forwarded",
                E_FORWARD);
